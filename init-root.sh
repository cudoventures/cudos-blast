...
cudos-noded add-genesis-account $ACCOUNT_1_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_2_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_3_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_4_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_5_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_6_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_7_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_8_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_9_ADDRESS "1000000000000000000000000${BOND_DENOM}"
...
cudos-noded add-genesis-account $ACCOUNT_10_ADDRESS "1000000000000000000000000${BOND_DENOM}"
