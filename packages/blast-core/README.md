...
| ---                                                          | ---                                                                                                                                                                   | ---                                                                                                                                                          |
| async getSigners()                                           | Returns an array of predefined accounts (`{project_root}/local-accounts.json`) including the auto generated additional accounts                                       | const [alice, bob] = await bre.getSigners()                                                                                                                  |
