...
export COMPOSE='docker compose -f ./packages/blast-core/config/docker-compose-start.yaml -f ./packages/blast-core/config/docker-compose-init.yaml exec -T cudos-node'
export COMPOSE_BASIC='docker compose -f ./packages/blast-core/config/docker-compose-start.yaml -f ./packages/blast-core/config/docker-compose-init.yaml'
red='\033[0;31m'
green='\033[0;32m'
reset_color='\033[m'
